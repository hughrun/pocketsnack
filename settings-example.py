...
exclude_tags = ['GLAM Blog Club', 'aus glam blogs', 'empocketer'] # if replace_all_tags is set to True, you can still retain particular tags by adding them to the exclude_tags list. note this is case insensitive
